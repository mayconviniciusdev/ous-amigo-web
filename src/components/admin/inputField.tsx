...
export const InputField = ({type, value, onChange, placeholder, disabled, errorMessage}: Props) => {
  return (
    <div className="w-full my-3">
      ...
      disabled={disabled}
      className={`w-full block text-lg p-3 outline-none rounded bg-gray-900 text-[#F6F6F6]
      border-b-2 ${errorMessage ? 'border-red-600' : 'border-gray-900'} focus:border-[#F6F6F6]`}/>
